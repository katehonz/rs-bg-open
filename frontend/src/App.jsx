...
import TechnologyCards from './pages/production/TechnologyCards';
      ...
      <Router>
        <Routes>
          ...
          >
            ...
            <Route path="accounting/currency-revaluation" element={<CurrencyRevaluation />} />
            <Route path="accounting/chart" element={<ChartOfAccounts />} />
            <Route path="production" element={<TechnologyCards />} />
            <Route path="production/technology-cards" element={<TechnologyCards />} />
