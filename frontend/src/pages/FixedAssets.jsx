...
import AssetAdjustmentsHistory from '../components/fixedAssets/AssetAdjustmentsHistory';
...
export default function FixedAssets() {
  ...
  const tabs = [
    ...
    { id: 'adjustments', label: 'Корекции', icon: '📈' },
    ...
    { id: 'reports-dma', label: 'Справки ДМА', icon: '📑' }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          ...
          {activeTab === 'adjustments' && <AssetAdjustmentsHistory />}
