...
export default function AssetsList({ onRefreshStats }) {
  ...
  const handleAdjustmentOpen = (asset, type) => {
  ...
  return (
    <>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    {asset.status === 'active' && (
                      <>
                        <button
                          onClick={() => handleAdjustmentOpen(asset, 'improvement')}
                        ...
                        <button
                          onClick={() => handleAdjustmentOpen(asset, 'impairment')}
      ...
      {/* Adjustment Modal */}
      {showAdjustmentModal && adjustingAsset && (
