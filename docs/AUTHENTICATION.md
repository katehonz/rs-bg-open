...
### Компании Query и Permissions

Системата прилага различни правила за визуализация на компании в зависимост от групата на потребителя:

**Superadmin и Admin потребители:**
- Виждат **всички компании** в системата
- Не е необходимо да бъдат добавени към user_companies за конкретна компания
- Имат глобален достъп за административни цели

**Обикновени потребители (User, Viewer и др.):**
- Виждат **само компаниите**, към които са добавени в user_companies
- Трябва да имат активен запис в user_companies.is_active = true
- Не могат да виждат други компании в системата

Това поведение е имплементирано в `backend/src/graphql/admin_resolvers.rs:companies()` query.
...
# Database
DATABASE_URL=postgresql://app:CHANGE_ME_IN_PRODUCTION@localhost:5432/accounting
```
