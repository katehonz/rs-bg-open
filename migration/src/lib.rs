...
mod m20251101_000001_add_observer_user_group;
mod m20251101_000002_add_recovery_code_fields;
mod m20251102_000001_add_more_currencies;
mod m20251105_000001_add_preferred_rate_provider;
mod m20251111_000001_add_vat_rate;
mod m20251120_000001_create_asset_value_adjustments;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20251101_000001_add_observer_user_group::Migration),
            Box::new(m20251101_000002_add_recovery_code_fields::Migration),
            Box::new(m20251102_000001_add_more_currencies::Migration),
            Box::new(m20251105_000001_add_preferred_rate_provider::Migration),
            Box::new(m20251111_000001_add_vat_rate::Migration),
            Box::new(m20251120_000001_create_asset_value_adjustments::Migration),
