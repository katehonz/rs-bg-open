...
pub struct Model {
    ...
    /// Account code for debit when asset value increases (improvements)
    pub improvement_debit_account_code: Option<String>,

    /// Account code for credit when asset value increases (improvements)
    pub improvement_credit_account_code: Option<String>,

    /// Account code for debit when asset value decreases (impairments)
    pub impairment_debit_account_code: Option<String>,

    /// Account code for credit when asset value decreases (impairments)
    pub impairment_credit_account_code: Option<String>,

    /// Account code for debit when asset is disposed
    pub disposal_debit_account_code: Option<String>,

    /// Account code for credit when asset is disposed
    pub disposal_credit_account_code: Option<String>,
