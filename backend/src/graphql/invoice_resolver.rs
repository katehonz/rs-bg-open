...
impl InvoiceMutation {
    ...
    async fn create_vat_journal_from_ai(
        ...
        let journal_input = CreateJournalEntryInput {
            ...
            company_id,
            lines,
            document_type: None, // Invoice type is tracked in vat_document_type
            ...
            vat_rate: None, // VAT rate can be calculated from amounts if needed
        };
...
impl From<ProcessedInvoice> for InvoiceProcessingPayload {
    fn from(value: ProcessedInvoice) -> Self {
        Self {
            ...
            auto_created_counterpart_id: value.auto_created_counterpart_id,
        }
    }
}
